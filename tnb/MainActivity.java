...
public class MainActivity extends AppCompatActivity {
    ...
    private void calculateBill() {
        try {
            ...
            // Calculate bill
            double totalBillBeforeRebate = calculateBillAmount(units, 0); // Bill amount before rebate
            double totalRebate = totalBillBeforeRebate * rebate / 100.0;  // Total rebate amount
            double totalBillAfterRebate = totalBillBeforeRebate - totalRebate; // Bill amount after rebate

            // Display result
            String resultText = "Electricity Bill Before Rebate: RM" + df.format(totalBillBeforeRebate) + "\n\n" +
                    "Total Rebate: RM" + df.format(totalRebate) + "\n\n" +
                    "Electricity Bill After Rebate: RM" + df.format(totalBillAfterRebate);
    ...
    private double calculateBillAmount(int units, double rebate) {
        ...
        // Apply rebate (not necessary in this function anymore)
